ALTER TABLE system_building_templates
    RENAME TO system_template_buildings;
...
ALTER TABLE system_scene_buildings
    ...
    FOREIGN KEY (template_id) REFERENCES system_template_buildings(id);

ALTER TABLE system_agent_templates
    RENAME TO system_template_agents;
...
ALTER TABLE system_scene_agents
    ...
    FOREIGN KEY (template_id) REFERENCES system_template_agents(id);
